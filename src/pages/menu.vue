  ...
  <VCard>
    ...
    <VCardItem>
      <VRow>
        ...
        <VCol cols="3">
          <VBtn color="purple" prepend-icon="mdi-food" block height="50">เมนูบุฟเฟต์ / อาหาร</VBtn>  
        </VCol>
        <VCol cols="3">
          <VBtn color="green" prepend-icon="mdi-pot" block height="50">น้ำจิ้ม / น้ำซุป</VBtn>  
        </VCol>
        <VCol cols="3">
          <VBtn color="red" prepend-icon="mdi-beer" block height="50">เครื่องดื่ม / อื่น ๆ</VBtn>  
        </VCol>
      </VRow>          
    </VCardItem>
    <VCardItem>
